...
def parse_args_and_config():
    ...
    parser.add_argument(
        "--operator_imp", type=str, default="FFT", help="SVD | FFT"
    )
    parser.add_argument(
        "--scale_ls", type=float, default=1.0, help="scale_for_gLS"
    )
    parser.add_argument(
        "--inject_noise", type=int, default=1, help="inject_noise --- separates between G- and G+"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--mode", type=str, default="G-", choices=["G+", "G-"],
        help="Select mode: G+ for PSNR enhancement with spatial gradient regularization, G- for LPIPS with frequency gradient regularization"
    )
    parser.add_argument(
        "--lam", type=float, default=-0.09, help="Lambda parameter for gradient regularization"
    )
    parser.add_argument(
        "--alpha", type=float, default=0.5, help="Alpha parameter for gradient regularization"
    )
    parser.add_argument(
        "--sigma_g", type=float, default=1.5, help="sigma_g parameter for gradient regularization"
    )
